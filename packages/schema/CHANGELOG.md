...
- [#19](https://github.com/Thinkmill/graphql-ts/pull/19) [`81465754bd18305ec9d3603273a108c408531fd5`](https://github.com/Thinkmill/graphql-ts/commit/81465754bd18305ec9d3603273a108c408531fd5) Thanks [@emmatown](https://github.com/emmatown)! - The `graphql` export has been renamed to `g` to make reading/writing schemas more concise and to avoid conflicts with exports named `graphql` from libraries such as Relay, GraphQL Code Generator and gql.tada that use the variable name `graphql` to declare GraphQL operations.
